...
class MaskRCNN(_MaskRCNN):
    ...
    def __init__(self, backbone, num_classes, batch_norm=None, train_encoder=True):
        ...
        super(MaskRCNN, self).__init__(backbone_model, num_classes, box_detections_per_img=1)
        ...
        if not train_encoder:
            ...
            # self.roi_heads.box_predictor.bbox_pred.requires_grad_(False)
    ...
    def forward(self, inputs, targets=None):
        ...
        outputs_raw = super(MaskRCNN, self).forward([i for i in inputs], targets)
